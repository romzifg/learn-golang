...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root:root123@tcp(localhost:3306)/golang_restful_test")
...
func TestCategoryUpdateFailed(t *testing.T) {
	db := setupTestDB()
	truncateCategory(db)
...
func TestCategoryGetFailed(t *testing.T) {
	db := setupTestDB()
	truncateCategory(db)
